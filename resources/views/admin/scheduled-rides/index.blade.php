    ...
    <section class="content">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <div class="col-4 col-md-4 text-right">
                                <a href="{{ url('scheduled-rides/createrequest') }}" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i>Add New Booking</a>
        ...
        <script>
            ...
            function getPaid(id){
                $.ajax({
                    type: "GET",
                    url: "https://tagxi-server.atyarealtors.com/api/v1/adminetapaid/"+id,
                    //data: { id:id }, 
