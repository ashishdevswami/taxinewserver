                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <input class="trip_count" type="hidden" value="<?php echo sizeof($resultsCount);?>">
                    ...
                    <audio id="myAudio" style="opacity:0" preload>
                          <source src="https://tagxi-server.atyarealtors.com/RaiwayAlertTone.mp3" type="audio/mpeg" >
                          Your browser does not support the audio element.
                        </audio>
                        <button  onclick="playaudio()" style="opacity:0">Play Audio</button>

                    <div id="js-request-partial-target" class="table-responsive">
                        <include-fragment src="pendingrequests/fetch">
        ...
        <script>
            function playaudio(){
             ...
             setInterval(function () { 
                 $.ajax({
                    type: "GET",
                    url: "https://tagxi-server.atyarealtors.com/api/v1/getlatestdata",
                    //data: { id:id }, 
                    success: function( msg ) {
                        var getCount = $('.trip_count').val();
                        if(getCount< msg){
                            playaudio();
                            $('.trip_count').val(msg);
                            alert('New Request has been arrived');
            ...
            function updatedriver(id,obj){
                $.ajax({
                    type: "GET",
                    url: "https://tagxi-server.atyarealtors.com/api/v1/updatedriverdata/"+id+"/"+$(obj).val(),
                    //data: { id:id }, 
                    success: function( msg ) {
                        window.location.reload();
                    }
