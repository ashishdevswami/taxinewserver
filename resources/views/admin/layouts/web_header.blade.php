...
<body data-spy="scroll" data-target=".navbar" data-offset="71">
  ...
  <nav class="navbar navbar-expand-xl navbar-light fixed-top py-2 border-bottom" style="background-color:{{ $data->menucolor }};">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand order-1 order-md-1" href="index.php" style="color: #3A1E74;">
        @if($data)
        
        <img src="https://jag.cab/assets/website/assets/img/logo.png" alt="Logo" style="max-width: 60px;">
        Jab.Cab
        @endif
      </a>
