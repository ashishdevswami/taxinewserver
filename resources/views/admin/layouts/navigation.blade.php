        ...
        <ul class="treeview-menu">
          ...
          <li class="{{'scheduled-rides' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('/scheduled-rides')}}">
              <i class="fa fa-circle-thin"></i> <span>Guaranteed Ride</span>
            </a>
          </li>
          <li class="{{'pendingrequests' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('/pendingrequests')}}">
              <i class="fa fa-circle-thin"></i> <span>Pending Request</span>
            </a>
          </li>
...
<!--           @if(auth()->user()->can('list-vehicle_fare'))
      ...
      <?php /*?><li class="treeview {{ 'fleet-drivers' == $main_menu ? 'active menu-open' : '' }}">
        <a href="javascript: void(0);">
          <i class="fa fa-users"></i>
