...
//Fleet drivers
   ...
   // Zone CRUD
        ...
        Route::group(['prefix' => 'scheduled-rides',  'middleware' => 'permission:view-requests'], function () {
            ...
            Route::get('/createrequest', 'RequestController@ScheduledNewRequest');
            
        });
        
        Route::group(['prefix' => 'pendingrequests',  'middleware' => 'permission:view-requests'], function () {
            Route::get('/', 'RequestController@indexPending');
            Route::get('/fetch', 'RequestController@getAllPendingRequest');
            //Route::get('/createrequest', 'RequestController@ScheduledNewRequest');
