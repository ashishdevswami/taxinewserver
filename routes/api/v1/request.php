...
Route::middleware('guest')->namespace('Request')->group(function () {
      Route::post('admincreate', 'CreateRequestController@createadminRequest');
      Route::post('admineta', 'EtaController@admineta');
      Route::get('adminetapaid/{id}', 'CreateRequestController@createadminpaid');
      Route::get('updatedriverdata/{id}/{driver}', 'CreateRequestController@updatedriverdata');
      Route::get('getlatestdata', 'CreateRequestController@getlatestdata');
