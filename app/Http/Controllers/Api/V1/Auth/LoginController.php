...
class LoginController extends BaseLoginController
{
    ...
    */
    ...
    public function sendUserLoginOTP(SendLoginOTPRequest $request)
    {
        ...
        $postData = array();
	    $url2 =  "https://japi.instaalerts.zone/httpapi/QueryStringReceiver?ver=1.0&key=mBIzDklFILAuCTBUPDpMUw==&encrpt=0&dest=91".$mobile."&send=JAGCBV&dlt_entity_id=1001245088130178315&text=Hi,%20Dear%20User%20Please%20enter%20this%20OTP%20%7b%23".$otp."%23%7d%20in%20your%20App%20to%20use%20the%20Rs%20200%20Tricity%20Travel%20Service%20JAG%20CAB";
        $curl2 = curl_init();
        ...
        */
        ...
        return $this->respondSuccess(['otp'=>$otp,'uuid' => $user->getCreatedOTPUuid()]);
    }
